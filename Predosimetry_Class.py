...
class Geometrical_points:
    def __init__(self,path,file_name,List_Nom):
        self.List_Nom=List_Nom
        self.path=path
        
        self.Import=Import(self.path,self.List_Nom)
        self.List_Patient=self.Import.list_patient_path()
        self.List_img , self.List_position =self.Import.read_nii_file()
